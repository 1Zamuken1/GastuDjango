    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, help_text='Nombre de pantalla visible en la app. No tiene que ser unico.', max_length=150, verbose_name='nombre de pantalla')),
